...
public extension FiberReconciler {
  ...
  final class Fiber {
    ...
    init<V: View>(
      ...
      typeInfo = AndroidSwiftUI.typeInfo(of: V.self)
    ...
    private func bindProperties(
      ...
      for property in typeInfo.properties where property.type is DynamicProperty.Type {
        ...
        bindProperties(to: &value, AndroidSwiftUI.typeInfo(of: property.type), environment)
    ...
    private func updateDynamicProperties(
      ...
      for property in typeInfo.properties where property.type is DynamicProperty.Type {
        ...
        updateDynamicProperties(of: &value, AndroidSwiftUI.typeInfo(of: property.type))
        // swiftlint:disable:next force_cast
    ...
    init<A: App>(
      ...
      element = rootElement
      typeInfo = AndroidSwiftUI.typeInfo(of: A.self)
    ...
    init<S: Scene>(
      ...
      self.element = element
      self.preferenceParent = preferenceParent
      typeInfo = AndroidSwiftUI.typeInfo(of: S.self)
